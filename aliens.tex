...
\abstract{
Children learn many instances of cultural norms through direct instruction (e.g. ``red lights mean stop''), but not all conventional knowledge is stated explicitly.  We investigate the hypothesis that children infer generalizable information about the world using speakers' descriptive word choices.  We introduced preschoolers to picture triads: an exemplar, and one picture that varied from it by size and one picture that varied from it by feature.  We described the exemplar using either a size or feature adjective, and asked children which of the two other pictures  they thought other category members looked like.  In Experiment 1, we used a supportive contrastive framing and found that by age 3.5, children reliable made contrast inferences for both size and feature terms.  In Experiment 2, performance was reduced when the contrastive framing was removed and children had to infer contrast from adjective presence alone.  In Experiment 3, we increased the salience of adjective contrasts by reading children a book of opposites before the task, and this exposure moderately boosted their performance.  In all, preschoolers show evidence of making contrast inferences about novel category members from speakers' descriptive choices. Sensitivity to why speakers choose to form their utterances in particular ways may allow children to infer normative information about the world. 
...
\section{Experiment 1: contrastive framing}
...
\section{Experiment 2: adjective only}
